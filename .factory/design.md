...
- `social-preview.webp` is a 1200×630 paper-backed composition derived locally from the same original hero; `apple-touch-icon.png` is a 180×180 raster of the hand-authored favicon. Neither adds third-party material.
